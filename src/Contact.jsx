...
import { Github, Linkedin, Mail, Youtube ,ArrowUpRight } from "lucide-react";

const contacts = [
  {
    name: "LinkedIn",
    Icon: Linkedin,
    link: "https://www.linkedin.com/in/gunjanch5/",
    bg: "bg-[#7DC2FF]",
  ...
  },
  {
    name: "GitHub",
    Icon: Github,
    link: "https://github.com/Gunjankumar55",
    bg: "bg-brand-bg",
  ...
  name: "Email",
  Icon: Mail,
  link: "mailto:gunjankumarchoudhari@gmail.com",
  bg: "bg-brand-bg",
...
},
 {
  name: "YouTube",
  Icon: Youtube,
  link: "https://www.youtube.com/@CodeSpirit_5",
  bg: "bg-[#EB4E63]",
      ...
      <div className="max-w-4xl mx-auto z-10 relative">
        ...
        <div className="mt-12 sm:mt-16 bg-brand-rose border-3 border-brand-dark p-4 sm:p-6 text-center neo-shadow max-w-2xl mx-auto rotate-[-1deg] hover:rotate-0 transition-transform duration-200">
          <p className="font-display font-extrabold text-base sm:text-lg md:text-xl text-brand-dark uppercase tracking-wide">
            Always open to building, learning, and connecting.
          </p>
        </div>
      </div>
    </section>
