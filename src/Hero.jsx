  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-6xl flex flex-col lg:flex-row items-center justify-center gap-10 lg:gap-16">
        ...
        >
          <a
            href="https://gunjankumar55.github.io/resume/"
            target="_blank"
        ...
        <motion.div
          ...
          className="flex-shrink-0 w-52 h-52 sm:w-64 sm:h-64 lg:w-80 lg:h-80 border-4 border-brand-dark neo-shadow overflow-hidden bg-[#FBFAF7]"
        >
          <img
            src={profilePic}
            alt={name}
